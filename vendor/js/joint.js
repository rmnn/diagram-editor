...
joint.dia.ElementView = joint.dia.CellView.extend({
    ...
    update: function (cell, renderingOnlyAttrs) {
        ...
        _.each(renderingOnlyAttrs || allAttrs, function (attrs, selector) {
            ...
            if (!_.isUndefined(attrs['ref-x']) || !_.isUndefined(attrs['ref-y']) || !_.isUndefined(attrs['ref-dx']) || !_.isUndefined(attrs['ref-dy']) || !_.isUndefined(attrs['x-alignment']) || !_.isUndefined(attrs['y-alignment'])
                ) {
